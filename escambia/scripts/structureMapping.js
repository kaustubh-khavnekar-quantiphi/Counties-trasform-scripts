...
function main() {
  ...
  // Note: structure_data.json intermediate file removed to avoid validation errors
  // data_extractor.js will extract structures directly from HTML using buildStructureFromBuilding
  console.log("Structure mapping complete: extracted", structures.length, "structure(s)");
  console.log("Note: Structures will be generated by data_extractor.js from building data");
}
