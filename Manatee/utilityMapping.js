...
function buildUtility(input) {
  // From tax and features we can infer public utilities and sprinklers, pool, etc.
  ...
  // Apartments complex likely has central air in FL, but we cannot assume; keep nulls per schema.
  return util;
}
