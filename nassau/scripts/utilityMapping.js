...
function run() {
  ...
  // Create utility for each building
  $('section.buildings .building-data').each((buildingIndex, buildingElement) => {
    // Extract utility data from building's structural elements
    let ac = "", ht = "";
  ...
  console.log("Wrote owners/utilities_data.json for", propId, "with", utilities.length, "utilities");
}
